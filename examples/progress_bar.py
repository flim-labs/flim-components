...
class ProgressBarExampleWindow(QWidget):
    ...
    def start_progress(self):
        self.progress_bar.set_style(ProgressBarStyles.progress_bar_style(color="#1E90FF"))  
        import time
    ...
    def on_progress_complete(self):
        self.progress_bar.set_style(ProgressBarStyles.progress_bar_style(color="lightgrey"))  
